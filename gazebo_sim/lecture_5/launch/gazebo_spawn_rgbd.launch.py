...
def generate_launch_description():
    ...
    # )
    # lecture_1/src/external_packages/ARIAC_logic_camera/ariac_sensors/models/basic_logical_camera/model.sdf
    sdf_dir = os.path.join(get_package_share_directory('ariac_sensors'), 'models/rgbd_camera')
    ...
    spawn_entity = Node(package='gazebo_ros',
                    ...
                    arguments=[ '-entity','rgbd_camera','-file', sdf_file,
                                '-x','1.0',
                                '-y','1.0',
                                '-z', '1.5',
                                '-R','0.0',
