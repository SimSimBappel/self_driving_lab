// #include "omtp_factory_moveit_config/move_robot_server.hpp"
...
// static const double MAX_VELOCITY_SCALE = 0.4;
// static const double MAX_ACCELERATION_SCALE = 0.4;
...
//     // service_example_server_ = this->create_service<MoveRobot::srv::ExampleService>(
//     //         "/robot_service",
...
// void MoveRobot::MoveGripper(const std_msgs::msg::Float64MultiArray & msg)
// {
...
// void MoveRobot::Move(const geometry_msgs::msg::PoseStamped & msg)
// {
...
//               }
// }
// // void MoveRobot::service_example_callback(const std::shared_ptr<ar4_moveit_config::srv::MoveRobot::Request> request,
...
static const double PLANNING_TIME_S = 15.0;
static const double MAX_VELOCITY_SCALE = 0.6;
static const double MAX_ACCELERATION_SCALE = 0.6;
static const unsigned int PLANNING_ATTEMPTS = 5;
// static const double GOAL_TOLERANCE = 1e-3;
static const std::string PLANNING_GROUP = "panda_1";
