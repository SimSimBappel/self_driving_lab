// #ifndef OMTP_FACTORY_MOVEIT_CONFIG__PACKAGE_MOVE_ROBOT_SERVER_HPP_
// #define OMTP_FACTORY_MOVEIT_CONFIG__PACKAGE_MOVE_ROBOT_SERVER_HPP_
...
//     void MoveGripper(const std_msgs::msg::Float64MultiArray & msg);
//     void Move(const geometry_msgs::msg::PoseStamped & msg);
