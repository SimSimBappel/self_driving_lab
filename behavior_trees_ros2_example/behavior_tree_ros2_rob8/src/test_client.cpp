...
int main(int argc, char **argv)
{
  ...
  params_database_place_chemical.nh = nh;
  ...
  // params_database_place_vessel.nh = shared_from_this();
  params_database_remove_chemical_placement.nh = nh;
  ...
  // params_database_place_vessel.nh = shared_from_this();
  params_database_remove_vessel_placement.nh = nh;
  ...
  params_gripper.server_timeout = std::chrono::milliseconds(4000);
  params_gripper.wait_for_server_timeout = std::chrono::milliseconds(4000);
  ...
  params_gripper_franka_homing.server_timeout = std::chrono::milliseconds(4000);
  params_gripper_franka_homing.wait_for_server_timeout = std::chrono::milliseconds(8000);
  ...
  params_gripper_franka_move.server_timeout = std::chrono::milliseconds(4000);
  params_gripper_franka_move.wait_for_server_timeout = std::chrono::milliseconds(8000);
...
////////////////////////////////////////////////////////////////////////////////////////
  ...
  params_arm_move_joints_relative.nh = nh;
  ...
  params_arm_move_trajectory_pour_msg.nh = nh;
